                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="~/assets/landing/img/logo/logo.svg" alt="Logo" />
                            </a>
                            <button
            ...
            <div class="row align-items-center position-relative">
                <div class="col-lg-6">
                    <div class="hero-content">
                        <h1 class="wow fadeInUp" data-wow-delay=".4s">Believers Sword</h1>
                ...
                <div class="col-lg-6">
                    <div class="hero-img wow fadeInUp" data-wow-delay=".5s">
                        <img src="~/assets/landing/img/hero/hero-img.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="about-img">
                        <img src="~/assets/landing/img/about/about-1.png" alt="" class="w-100" />
                        <img src="~/assets/landing/img/about/about-left-shape.svg" alt="" class="shape shape-1" />
                        <img src="~/assets/landing/img/about/left-dots.svg" alt="" class="shape shape-2" />
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
                    <div class="about-content">
                        <div class="section-title mb-30">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".4s">
                                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed dinonumy eirmod tempor
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 order-first order-lg-last">
                    <div class="about-img-2">
                        <img src="~/assets/landing/img/about/about-2.png" alt="" class="w-100" />
                        <img src="~/assets/landing/img/about/about-right-shape.svg" alt="" class="shape shape-1" />
                        <img src="~/assets/landing/img/about/right-dots.svg" alt="" class="shape shape-2" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-5 col-xl-6 col-lg-8 col-md-9">
                        <div class="section-title text-center mb-60">
                            <h2 class="mb-25 wow fadeInUp" data-wow-delay=".2s">Why Choose SaaSpal</h2>
                            <p class="wow fadeInUp" data-wow-delay=".4s">
                                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="footer-widget">
                            <div class="logo mb-30">
                                <a href="index.html">
                                    <img src="~/assets/landing/img/logo/logo.svg" alt="" />
                                </a>
                            </div>
...
<style scoped>
@import url("~/assets/landing/css/bootstrap.min.css");
@import url("~/assets/landing/css/lineicons.css");
@import url("~/assets/landing/css/animate.css");
@import url("~/assets/landing/css/main.css");
</style>
