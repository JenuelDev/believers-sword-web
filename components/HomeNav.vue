...
<template>
    ...
    >
        <div class="flex flex-row items-center header-nav">
            <NuxtLink to="/" class="mx-3px" :class="{ 'nav-active': route.path == '/' }"> Home </NuxtLink>
            <NuxtLink to="/how-to-download" class="mx-3px">How To Install</NuxtLink>
            <a href="/donate" class="mx-3px"> Donate </a>
